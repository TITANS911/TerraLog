...
const PetugasDashboard = () => {
  ...
  const menuItems = [
    { id: 'dash', icon: <LayoutDashboard size={20} />, label: 'Overview' },
    { id: 'tugas', icon: <Truck size={20} />, label: 'Jadwal Jemput' },
    { id: 'rute', icon: <MapPin size={20} />, label: 'Rute Lokasi' },
    { id: 'riwayat', icon: <CheckCircle size={20} />, label: 'Riwayat Selesai' },
    { id: 'notif', icon: <Bell size={20} />, label: 'Notifikasi Tugas' },
  ];
