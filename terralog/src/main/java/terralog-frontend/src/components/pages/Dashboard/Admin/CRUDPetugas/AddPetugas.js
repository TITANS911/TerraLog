...
const AddPetugas = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Buat payload data agar sesuai dengan kolom database di backend
        const payload = {
            nama: formData.nama,
            username: formData.username,
            no_hp: formData.noHp, // Mapping ke snake_case untuk Java
            alamat: formData.alamat,
            komplek: formData.komplek,
            role: formData.role
        };

        // Jika password diisi (untuk tambah baru atau ganti password), masukkan ke payload
